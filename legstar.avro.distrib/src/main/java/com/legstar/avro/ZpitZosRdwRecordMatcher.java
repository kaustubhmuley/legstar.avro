 ...
 * 
 */
public class ZpitZosRdwRecordMatcher extends RdwCobolComplexTypeFinder {

    public ZpitZosRdwRecordMatcher() {
        super(new EbcdicCobolContext(), new CobolZpitRec(), "filler3");
    }
